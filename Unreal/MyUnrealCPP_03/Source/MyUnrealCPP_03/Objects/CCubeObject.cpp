#include "Objects/CCubeObject.h"
#include "Global.h"
#include "ProceduralMeshComponent.h"

ACCubeObject::ACCubeObject()
{
...
void ACCubeObject::BeginPlay()
{
	Super::BeginPlay();
}

void ACCubeObject::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void ACCubeObject::AddTriangles(int32 InStart)
{
